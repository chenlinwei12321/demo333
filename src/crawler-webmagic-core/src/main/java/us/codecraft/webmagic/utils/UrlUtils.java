...
public class UrlUtils {
	...
	public static String getBaseDomain(String url) {
		...
		return InternetDomainName.from(getDomain(url)).topPrivateDomain().toString();
	}
	 ...
	 * @return
	 */
	public static String relativeToAbsolute(String currentUrl, String relativeUrl){
		try {
			URL abs = new URL(currentUrl);
			URL rel = new URL(abs, relativeUrl);
			return rel.toString();
		} catch (MalformedURLException e) {
//            e.printStackTrace();
		}
