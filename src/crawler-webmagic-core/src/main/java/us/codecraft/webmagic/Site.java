...
public class Site {
     ...
     * 新增，是否使用代理池
     */
    private boolean useHTTPProxyPool = false;
...
//        DEFAULT_STATUS_CODE_SET.add(301);
//        DEFAULT_STATUS_CODE_SET.add(302);
    }
    ...
    public boolean isUseHTTPProxyPool() {
        return useHTTPProxyPool;
    }

    public Site setUseHTTPProxyPool(boolean useHTTPProxyPool) {
        this.useHTTPProxyPool = useHTTPProxyPool;
        return this;
    }
